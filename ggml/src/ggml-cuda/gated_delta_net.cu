...
static void launch_gated_delta_net(
    ...
    switch (S_v) {
        ...
        case 64:
            ...
            break;
        case 128: {
            // Grouped prefill kernel (Ampere/AMD, S_v=128, non-tree, non-KDA, with intermediates).
            // Pure-AR path (WRITE_INTER=false) uses gdn_kernel_launch with state_out_d for in-place.
            if constexpr (!KDA && !TREE_MODE && WRITE_INTER) {
